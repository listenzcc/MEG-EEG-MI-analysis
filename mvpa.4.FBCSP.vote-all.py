...
data_directory = Path(f'./data/MVPA.FBCSP.all.vote/{subject_name}')
...
# Play ground
if meg_epochs:
    meg_epochs = meg_epochs.copy().pick_types(meg=True, ref_meg=False)

epochs = eeg_epochs.copy()
epochs.add_channels([meg_epochs.copy()])
print(epochs)
